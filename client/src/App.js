...
export default class App extends Component {
  ...
  handleSubmit(e) {
    ...
    if (this.state.username.length > 0) {
      ...
      AddUser(this.state.username, () => {
        ...
        login((data) => {
          ...
          let msg = ` <h5 style='color:lightblue;'id='head'>${
            data.numUsers === 1
              ? " 1 participant"
              : `${data.numUsers} participants`
          }</h5>`;
    ...
    typed((data) => {
      ...
      $(` .list-group li:contains(${data.username})`).html(
    ...
    return this.state.isUser ? (
      <div id="frame">
        ...
        <Content
          ...
          Emoji={this.showEmoji.bind(this)}
      ...
      <div className="content">
        <div className="contact-profile ">
          ...
          <div className="social-media">
            {<i className="ion-md-exit" onClick={this.props.Exit}></i> || (
              <button className="alert alert-success" OnClick={this.props.Exit}>
                Exit
              </button>
            )}
          </div>
          ...
          <div className="wrap">
            <form id="inputCont">
              <input
                type="text"
                id="texter"
                onBeforeInput={this.props.Typing}
                name="message"
              ...
              <button className="submit" onClick={this.props.sendMsg}>
    ...
    return (
      <div id="sidepanel">
        <div id="#contacts">
          <span>
            {" "}
            <p className="alert-alert-info text-center" id="header"></p>
          </span>
          <ul className="list-group text-center">
            Active users:
            {Active.length > 0
              ? Active.map((v, i) => (
                  <li className="list-group-item alert-info" id="users" key={i}>
                    {v}
                  </li>
                ))
              : null}
